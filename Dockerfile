...
USER root
ADD "https://github.com/tensorchord/pgvecto.rs/releases/download/v0.3.0/vectors-pg14_0.3.0_amd64.deb" /tmp/vectors.deb
...
RUN dpkg -x /tmp/pgvector.deb pgvector && rm -f /tmp/pgvector.deb && \
     ...
     rm -rf pgvector
ADD "https://github.com/tensorchord/VectorChord/releases/download/0.3.0/postgresql-14-vchord_0.3.0-1_amd64.deb" /tmp/vchord.deb
